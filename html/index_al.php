    ...
    <form action="login.php" method="POST">
      ...
      <div class="login__form">
        <div class="login__row">
          ...
          <input type="text" class="login__input name" name="email" placeholder="Perdoruesi"/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
          <input type="password" name="pw" class="login__input pass" placeholder="Fjalekalimi"/>
        </div>
          ...
          <div class="logmod__alter-container" >
            <a href="#" class="connect facebook">
              ...
              <div class="connect__context" style="font-size:15px">
                <span>Kycu me <strong>Facebook</strong></span>
              </div>
            </a>
            <a href="#" class="connect googleplus">
              ...
              <div class="connect__context" style="font-size:15px">
                <span>Kycu me <strong>Google+</strong></span>
              </div>
            </a>
          </div>
								...
								<tr>
									<td width="113" height="308">
										<!-- Tabele per sponsorat -->
										<table width="108">
											<tr><td colspan="5"><div align="center"><img alt="" height="75" src="../img/sponsors/sponsorat.png" /></div></td></tr>
											<tr>
