  ...
  <div class="demo">
    ...
    <p class="signup_intro"> <b>create your account</b></p>
        ...
        <div class="signup__row">
          ...
          <input class="signup_email" maxlength="255" id="user-email" placeholder="Email" type="email" size="50" />
        </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        ...
        <div class="signup__row">
          ...
          <input class="signup_pass" maxlength="255" id="user-pw" placeholder="Password" type="text" size="50" />
        </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        ...
        <div class="signup__row">
          ...
          <input class="signup_pass" maxlength="255" id="user-pw-repeat" placeholder="Repeat password" type="text" size="50" />
        </div>
		<p>&nbsp;</p>
        <p>&nbsp;</p>
		<p class="login__signup" align="left"><input class="checkbox" type="checkbox" value="Agree"/> &nbsp; I agree to &nbsp;<a><u>Terms & Privacy</u></a></p>
        <button type="button" class="signup__submit">Sign up</button>
      </div>
      </form>
    </div>
  </div>
