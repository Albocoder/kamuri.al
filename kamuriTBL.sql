...
-- Generation Time: Feb 09, 2016 at 03:09 PM
...
CREATE TABLE IF NOT EXISTS `kamuriTBL` (
  ...
  `pw` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'albocoder@gmail.com', 'erin', 'Elbasan,Albania', 'user.jpg', 1, 'bacon', '0', '0', 1),
